...
export function SentimentArcChart({ timeRange, onDrillDown }: SentimentArcChartProps) {
  ...
  return (
    <div className="widget insight-widget">
      <WidgetHeading title="Did we help? Sentiment arc by intent" infoText="Opening vs closing member sentiment by intent. Improvement suggests the call helped; decline may indicate unresolved issues." />
