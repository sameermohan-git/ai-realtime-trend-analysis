...
export function HandleTimeSentimentChart({ timeRange, onDrillDown }: HandleTimeSentimentChartProps) {
  ...
  return (
    <div className="widget insight-widget" style={{ position: 'relative' }}>
      <WidgetHeading title="Efficiency & satisfaction frontier" infoText="Handle time vs member sentiment by intent. Balances speed and member experience; use to spot intents that are slow or low-satisfaction." />
        ...
        <ResponsiveContainer width="100%" height={300}>
          <ScatterChart margin={{ left: 8, right: 16, bottom: 24, top: 8 }}>
            ...
            <YAxis
              ...
              stroke="var(--text-muted)"
              fontSize={11}
              label={{ value: 'Avg sentiment (0–10)', angle: -90, position: 'insideLeft', fill: 'var(--text-muted)', fontSize: 11 }}
            />
