...
export function VolumeOverTimeChart({ timeRange, onDrillDown }: VolumeOverTimeChartProps) {
  ...
  return (
    <div className="widget insight-widget">
      <WidgetHeading title="Call volume & complaints over time" infoText="Daily call volume and number of calls with complaint signals. Helps spot spikes and trends." />
