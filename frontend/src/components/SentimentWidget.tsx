...
export function SentimentWidget({ timeRange, onDrillDown }: SentimentWidgetProps) {
  ...
  return (
    <div className="widget">
      <WidgetHeading title="Member sentiment (by call)" infoText="Distribution of calls by average member sentiment (0–10, 5 = neutral). Click a segment to see those calls." />
